...
const DeleteTenantModal: React.FC<DeleteTenantModalProps> = ({ isOpen, onClose, onConfirm, tenantName }) => {
            ...
            <div className="bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 rounded-lg shadow-2xl w-full max-w-md">
                <div className="p-6">
                    ...
                    <p className="mt-2 text-slate-600 dark:text-slate-300">
                        ...
                        <strong className="text-red-600 dark:text-red-400">{tenantName}</strong>?
                    </p>
